/**
 * OAuth2 Authorization Code flow with PKCE for Cognito.
 */
...
/** Redirect the user to Cognito's authorization endpoint with PKCE. */
 ...
 * Returns null if no verifier is found (not a callback).
 */
