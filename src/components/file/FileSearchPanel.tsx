      ...
      <div className="p-4 space-y-3 border-b border-gray-200">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-9 pr-3 py-2 text-sm rounded-lg border border-gray-300 bg-gray-50 outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500/20"
          />
        </div>
            ...
            {results.map((file) => (
              ...
              >
                ...
                <button
                  ...
                  className="shrink-0 p-1.5 rounded-lg opacity-0 group-hover:opacity-100 hover:bg-gray-200 text-gray-400 hover:text-gray-600 transition-all"
                  title="フォルダで開く"
                >
