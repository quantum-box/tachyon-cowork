...
export function SlidePreview({ data }: Props) {
  ...
  return (
    <div className="border border-gray-200 rounded-lg overflow-hidden bg-white">
      ...
      {/* Slide view */}
      <div className="p-4">
        <div className="relative mx-auto max-w-lg aspect-[16/9] bg-white border border-gray-300 rounded-md shadow-sm overflow-hidden">
          {/* Slide content */}
      ...
      {/* Navigation */}
      <div className="flex items-center justify-center gap-4 px-3 py-2 border-t border-gray-200 bg-gray-50">
        <button
          onClick={goToPrev}
